{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyMy0+f0wPlutKUdIn8L3ZGB",
  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "df['Asset Sales'] = np.where(df['Sales'] > nearest_mean_sales, 'Good', np.where(df['Sales'] < nearest_mean_sales, 'Bad', 'Average'))\n",
        "scores = df['Asset Sales'].to_numpy()\n",
        "print('Asset Sales:', scores[7:10])"
      ],
      "metadata": {
        ...
        "id": "jGnPfShEaLR2",
        "outputId": "6a43a263-e304-4a4d-e63d-5865a882d8f8"
      },
      "execution_count": 81,
      "outputs": [
        {
